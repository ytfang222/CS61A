...
def distance(city1, city2):
    ...
    5.0
    """
    distance_lat = get_lat(city1) - get_lat(city2)
    distance_lon = get_lon(city1) - get_lon(city2)
...
def closer_city(lat, lon, city1, city2):
    ...
    distance_1 = distance(new_city, city1)
    distance_2 = distance(new_city, city2)
...
def add_chars(w1, w2):
    ...
    if not w1:
        return w2
    return add_chars(w1[1:],w2.replace(w1[0],'',1)) #最多replace一次
